...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { description: @pin.description, description: @pin.description, generate: @pin.generate, pins: @pin.pins, rails: @pin.rails, scaffold: @pin.scaffold }
    end
  ...
  test "should update pin" do
    patch :update, id: @pin, pin: { description: @pin.description, description: @pin.description, generate: @pin.generate, pins: @pin.pins, rails: @pin.rails, scaffold: @pin.scaffold }
    assert_redirected_to pin_path(assigns(:pin))
  end
